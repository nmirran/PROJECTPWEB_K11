<nav class="bg-[#ffc0cb] sticky top-0 z-50 shadow-sm" x-data="{ open: false }">
    <div class="container mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <div class="hidden md:flex items-center space-x-8">
            ...
            <a href="{{ url('/login') }}" class="bg-white text-[#ffc0cb] px-6 py-2 rounded-full font-bold border-2 border-white hover:bg-transparent hover:text-white transition duration-300">Login</a>
        </div>
    ...
    <div id="mobile-menu" class="hidden md:hidden bg-[#ffc0cb] border-t border-pink-200">
        <div class="flex flex-col p-6 space-y-4">
            ...
            <a href="{{ url('/login') }}" class="bg-white text-[#ffc0cb] py-3 rounded-xl text-center font-bold">Login</a>
        </div>
    </div>
</nav>
