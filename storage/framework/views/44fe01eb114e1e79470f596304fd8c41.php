...
<head>
    ...
    <style>
        body { background: linear-gradient(to bottom, #fff0f5, #ffe4e1); min-height: 100vh; font-family: 'Segoe UI', sans-serif; }
        .sidebar {
    ...
    <div class="row">
        <div class="col-md-3 sidebar p-0">
            <div class="p-4 text-center text-white">
                ...
                <p class="mb-0">Halo, <strong><?php echo e(auth()->user()->username); ?></strong></p>
            ...
            <div class="nav flex-column">
                ...
                <a href="<?php echo e(url('/logout')); ?>" class="nav-link text-white-50" onclick="return confirm('Yakin logout?')">
                     Logout
                </a>
            </div>
        </div>
        ...
        <div class="col-md-9 content-area">
            ...
            <p class="text-muted">Selamat datang kembali, Admin <?php echo e(auth()->user()->username); ?>!</p>
...
<?php /**PATH D:\COOLYEAHH!!\SMT 3\PROJECTPWEB_K11\resources\views/dashboard/admin/index.blade.php ENDPATH**/ ?>