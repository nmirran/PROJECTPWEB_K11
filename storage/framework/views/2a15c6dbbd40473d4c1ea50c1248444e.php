    ...
    <div class="card-edit">
        ...
        <form action="/owner/profil_toko_edit" method="POST">
            ...
            <div class="mb-3">
                ...
                <textarea name="deskripsi" class="form-control" rows="4" required><?php echo e($toko->deskripsi); ?></textarea>
            </div>
            ...
            <div class="mb-3">
                ...
                <select name="status" class="form-select" required>
                    <option value="buka" <?php echo e($toko->status == 'buka' ? 'selected' : ''); ?>>Buka</option>
                    <option value="tutup" <?php echo e($toko->status == 'tutup' ? 'selected' : ''); ?>>Tutup</option>
                </select>
            </div>
...
<?php /**PATH D:\COOLYEAHH!!\SMT 3\PROJECTPWEB_K11\resources\views/dashboard/owner/profil_toko_edit.blade.php ENDPATH**/ ?>