                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="text-truncate-2" title="<?php echo e($product->deskripsi_produk); ?>">
                                    <?php echo e($product->deskripsi_produk ?? '-'); ?>

                                </span>
                            </td>
                            <td>Rp <?php echo e(number_format($product->harga_produk, 0, ',', '.')); ?></td>
                            <td><?php echo e($product->stok_produk); ?></td>
                            <td>
                                <div class="action-buttons">
                                    <!-- Edit Button -->
                                    <a href="<?php echo e(route('produk.update', $product->id_produk)); ?>"
                                       class="btn-edit"
                                       title="Edit">
                                    ...
                                    <button class="btn-delete"
                                            ...
                                            data-bs-target="#deleteModal<?php echo e($product->id_produk); ?>"
                                            title="Hapus">
                                ...
                                <!-- Delete Modal -->
                                <div class="modal fade" id="deleteModal<?php echo e($product->id_produk); ?>" tabindex="-1">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <strong><?php echo e($product->nama_produk); ?></strong>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-cancel" data-bs-dismiss="modal">
                                                    Batal
                                                </button>
                                                <form action="<?php echo e(route('produk.delete', $product->id_produk)); ?>"
                                                      method="POST"
                                                      class="d-inline">
                                                    <?php echo csrf_field(); ?>
                        ...
                        <tr>
                            <td colspan="8" class="text-center py-4 text-muted">
                                Belum ada produk. <a href="<?php echo e(route('produk.create')); ?>">Tambah produk pertama</a>
                            </td>
                        </tr>
                        <?php endif; ?>
                    </tbody>
...
<?php /**PATH C:\laragon\www\PROJECTPWEB_K11\resources\views/admin/produk/index.blade.php ENDPATH**/ ?>