...
<header class="hero-pattern min-h-[70vh] flex items-center justify-center text-center px-4">
    <div class="max-w-3xl">
        ...
        <h1 class="text-5xl md:text-7xl font-bold text-gray-800 mb-6">
            Browny<span class="text-pink-500">Gift</span>
        </h1>
        ...
        <div class="flex flex-col md:flex-row items-center gap-12">
            ...
            <div class="md:w-1/2">
                ...
                <p class="text-gray-600 text-lg leading-relaxed mb-6">
                    BrownyGift berawal dari kecintaan kami pada keindahan bunga. Kami percaya setiap tangkai bunga memiliki makna mendalam untuk setiap perasaan yang ingin disampaikan.
                </p>
                <p class="text-gray-600 text-lg leading-relaxed">
                    Kami menyediakan berbagai macam pilihan bunga segar mulai dari Rose, Tulip, hingga Sunflower yang dirangkai secara profesional dan penuh cinta.
                </p>
            </div>
        </div>
    </div>
...
<section id="services" class="py-20 bg-pink-50">
    <div class="container mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="bg-white p-8 rounded-2xl shadow-sm hover:shadow-md transition text-center border-b-4 border-pink-400">
                <div class="w-16 h-16 bg-pink-100 rounded-full flex items-center justify-center mx-auto mb-6 text-pink-500 text-2xl">
                    <i class="fas fa-leaf"></i>
                </div>
                <h4 class="text-xl font-bold mb-3 text-gray-800">Bunga Segar</h4>
                <p class="text-gray-600 text-sm">Kami menggunakan bunga potong segar berkualitas yang dipilih setiap pagi.</p>
            </div>
            <div class="bg-white p-8 rounded-2xl shadow-sm hover:shadow-md transition text-center border-b-4 border-amber-400">
                <div class="w-16 h-16 bg-amber-100 rounded-full flex items-center justify-center mx-auto mb-6 text-amber-600 text-2xl">
                    <i class="fas fa-magic"></i>
                </div>
                <h4 class="text-xl font-bold mb-3 text-gray-800">Custom Design</h4>
                <p class="text-gray-600 text-sm">Sesuaikan warna kertas pembungkus dan jenis bunga sesuai keinginanmu.</p>
            </div>
            <div class="bg-white p-8 rounded-2xl shadow-sm hover:shadow-md transition text-center border-b-4 border-green-400">
                ...
                <p class="text-gray-600 text-sm">Pengiriman di hari yang sama untuk memastikan bunga tetap segar sampai tujuan.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="group bg-white rounded-2xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300">
                <div class="relative overflow-hidden">
                    <img src="<?php echo e($item['image_url']); ?>" alt="Buket <?php echo e($item['name']); ?>" class="w-full h-48 object-cover group-hover:scale-110 transition duration-500">
